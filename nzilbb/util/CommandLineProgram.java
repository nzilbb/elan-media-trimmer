...
public class CommandLineProgram {
   ...
   /**
    * Getter for {@link #version}: Whether to print version information.
    * @return Whether to print version information.
    */
   public Boolean getVersion() { return version; }
   /**
    * Setter for {@link #version}: Whether to print version information.
    * @param newVersion Whether to print version information.
    */
   @Switch("Whether to print version information")
   public CommandLineProgram setVersion(Boolean newVersion) { version = newVersion; return this; }
   
   /**
    * Version information retrieved from .jar file comment.
    * @see #getVersionInformation()
    * @see #setVersionInformation(String)
    */
   protected String versionInformation = "version unknown";
   /**
    * Getter for {@link #versionInformation}: Version information retrieved from .jar file comment.
    * @return Version information retrieved from .jar file comment.
    */
   public String getVersionInformation() { return versionInformation; }
   /**
    * Setter for {@link #versionInformation}: Version information retrieved from .jar file comment.
    * @param newVersionInformation Version information retrieved from .jar file comment.
    */
   public CommandLineProgram setVersionInformation(String newVersionInformation) { versionInformation = newVersionInformation; return this; }
   ...
   public CommandLineProgram() {
      ...
      try {
         ...
         if (thisClassUrl.toString().startsWith("jar:")) {
            ...
            versionInformation = thisJarFile.getComment();
         }
      } catch (Throwable t) {
      }      
   }
   ...
   public boolean processArguments(String argv[]) {
	 ...
	 if (switchAnnotation != null && method.getParameterTypes().length == 1) {
      ...
      // did they ask for version info?
      if (getVersion()) System.err.println(getVersionInformation());
